#!/usr/bin/env python3
"""
S1-TCP-LXMF-001: LXMF direct delivery through TCP shared daemon.
"""
...
def main():
    args = parse_args()
    t = SharedModeTest("S1-TCP-LXMF-001 lxmf_direct", rust_binary=args.rust_binary)
    ...
    try:
        ...
        if res_b and res_b.get("messages_received"):
            ...
            t.check(large_content in msg.get("content", ""), "Message content matches")
