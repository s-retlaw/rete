#!/usr/bin/env python3
"""
S1-UNX-LXMF-002: LXMF opportunistic delivery through Unix shared daemon.

Single-packet LXMF delivery (no link required).
"""
...
def main():
    args = parse_args()
    t = SharedModeTest("S1-UNX-LXMF-002 lxmf_opportunistic", rust_binary=args.rust_binary)
