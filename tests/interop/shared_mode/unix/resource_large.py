#!/usr/bin/env python3
"""
S1-UNX-RSRC-002: Large resource transfer through Unix shared daemon.
...
def main():
    args = parse_args()
    t = SharedModeTest("S1-UNX-RSRC-002 resource_large", rust_binary=args.rust_binary)

    # ~256KB payload — written to file (too large for command-line args)
    ...
    try:
        ...
        # Write payload to file for the client to read (avoids arg-too-long)
